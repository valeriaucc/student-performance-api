...
public interface EnrollmentMapper {
    ...
    @Mapping(source = "classEntity.teacher.id", target = "teacherId")
    @Mapping(source = "classEntity.teacher.fullName", target = "teacherName")
    @Mapping(source = "classEntity.teacher.email", target = "teacherEmail")
